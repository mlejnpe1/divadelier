...
const PROGRAM_STEPS = [
  ...
  },
  {
    ...
    text: "Centrem Vysokého Mýta procházejí členové divadelních skupin Divadeliéru v kostýmech andělů a nesou čtyři obří osvětlené loutky.",
  },
  {
  ...
  },
  {
    ...
    text: "V 17:00 se všichni sejdeme u chrámu svatého Vavřince. Let andělů není jen průvod. Je to společné ztišení prostoru tichým letem andělů, kterým se symbolicky otevírají Vánoce pro zrození lásky.",
  },
];
  ...
  return (
    <>
      <Hero
        ...
        description="Výrazná předvánoční akce Divadeliéru, při které městem procházejí andělé v kostýmech a nesou velké osvětlené loutky."
